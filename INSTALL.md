...
The standard Ubuntu repositories for Ubuntu 18.04 only provide install packages for NodeJS v4.  sealog-client-alvin-shoreside (and sealog-server-jason-shoreside) require nodeJS >= v8.11
